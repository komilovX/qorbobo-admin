<template>
  <div>
    ...
    >
        ...
        <template slot-scope="{ row }">
          ...
          >
            ...
            <el-table-column
              ...
              width="250"
            />
            <el-table-column label="Цена за единицу" align="center" width="250">
      ...
      <el-table-column sortable width="200" label="Дата" align="center">
    ...
    <app-pagination
      ...
      v-if="size > 50"
    />
    <el-dialog title="Инфо" :visible.sync="dialogVisible" width="50%">
