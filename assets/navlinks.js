export const navlinks = [
  ...
  { name: "Отчет по заказам", path: "/order-reports" },
  { name: "Отчет по клиентам", path: "/client-reports" },
...
export const routes = [
  ...
  { name: "Отчет по заказам", path: "/order-reports", origin: "/reports/order-reports" },
  { name: "Отчет по клиентам", path: "/client-reports", origin: "/reports/client-reports" },
